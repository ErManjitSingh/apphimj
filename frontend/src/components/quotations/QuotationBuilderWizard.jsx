  ...
  useEffect(() => {
    ...
    setState((s) => {
      ...
      const same =
        ...
        Number(prev.companyMarginBakedPercent || 0) === Number(nextPricing.companyMarginBakedPercent || 0) &&
        Boolean(prev.companyMarginBaked) === Boolean(nextPricing.companyMarginBaked) &&
